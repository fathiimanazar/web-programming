                ...
                <table cellpadding="5px" cellspacing="5px"  align="center">
                    ...
                    <tr>
                        <th colspan="2" style="text-align: center;">
                            <input type="submit" value="Add" name="add1" style="background-color: #c0c3c6;">
                        </th>
                    </tr>
                </table>
            </form>
        ...
        <div class="col-md-5" style="display: block;border-right: solid;border-width: 1px;">
            <form method="post" action="">
                <table cellpadding="5px" cellspacing="5px"  align="center">
                    ...
                    <tr>
                        <th colspan="2" style="text-align: center;">
                            <input type="submit" value="Add" name="add2" style="background-color: #c0c3c6;">
                        </th>
                    </tr>
                </table>
            </form>
        ...
        <div class="col-md-5" style="display: block;border-right: solid;border-width: 1px;">
            <form method="post" action="">
                <table cellpadding="5px" cellspacing="5px"  align="center">
                    ...
                    <tr>
                        <th colspan="2" style="text-align: center;">
                            <input type="submit" value="Add" name="add3" style="background-color: #c0c3c6;">
                        </th>
                    </tr>
                </table>
            </form>
